        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-group form-inline">
                    ...
                    <label>班级名称:</label>
                    <input type="text" name="classname" class="form-control" value="${clazz.classname}" readonly="readonly"/>
                </div>
                <div class="form-group form-inline">
                    <label>课程名称:</label>
                    <input type="text" name="course" class="form-control" value="${clazz.course}"readonly="readonly"/>
                </div>
                <div class="form-group form-inline">
                    <label>讲师:</label>&nbsp;&nbsp;&nbsp;
