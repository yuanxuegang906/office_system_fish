...
<title>滴答OA办公系统登录</title>
<link href="/css/login3.css" rel="stylesheet" rev="stylesheet" type="text/css" media="all" />
  ...
  <div class="tab_box"> 
    ...
    <div>
      ...
      <form action="/login" method="post" class="stu_login_error">
        ...
        <div class="username">
          <label>学&nbsp;&nbsp;&nbsp;号：</label>
          <input type="text" id="stu_username_hide" name="username" value="输入学号" nullmsg="学号不能为空！" datatype="s3-18" errormsg="学号范围在6~18个字符之间！" sucmsg="学号验证通过！"/>
          <!--ajaxurl="demo/valid.jsp"--> 
        </div>
        <div class="password">
          <label>密&nbsp;&nbsp;&nbsp;码：</label>
          <input type="password" id="stu_password_hide" name="password" value="输入密码" nullmsg="密码不能为空！" datatype="*3-16" errormsg="密码范围在6~16位之间！" sucmsg="密码验证通过！"/>
        </div>
        <div class="code">
          <label>验证码：</label>
   ...
   <!-- 导师登录开始-->
    <div class="hide">
     <div class="tea_error_box"></div>
      <form action="/login" method="post" class="tea_login_error">
        <div class="username">
          <label>职务：</label>
          <input type="radio" name="identity" value="teacher"  />讲师&nbsp;&nbsp;
          <input type="radio" name="identity" value="manager"  />班主任
          <!--ajaxurl="demo/valid.jsp"-->
        </div>
        <div class="username">
          <label>教工号：</label>
          <input type="text" id="tea_username_hide" name="username" value="输入教工号" nullmsg="教工号不能为空！" datatype="s3-18" errormsg="教工号范围在3~18个字符之间！" sucmsg="教工号验证通过！"/>
          <!--ajaxurl="demo/valid.jsp"--> 
        </div>
        <div class="password">
          <label>密&nbsp;&nbsp;&nbsp;码：</label>
          <input type="password" id="tea_password_hide" name="password" value="输入密码" nullmsg="密码不能为空！" datatype="*3-16" errormsg="密码范围在3~16位之间！" sucmsg="密码验证通过！"/>
        </div>
        <div class="code">
          <label>验证码：</label>
    ...
    <div class="sec_error_box"></div>
      <form action="/login" method="post" class="sec_login_error">
        <input type="hidden" name="identity" value="boss"/>
        <div id="username">
          <label>账号：</label>
          <input type="text" id="sec_username_hide" name="username" value="输入教务号" nullmsg="教务号不能为空！" datatype="s3-18" errormsg="教务号范围在3~18个字符之间！" sucmsg="教务号验证通过！"/>
          <!--ajaxurl="demo/valid.jsp"--> 
        </div>
        <div id="password">
          <label>密&nbsp;&nbsp;&nbsp;码：</label>
          <input type="password" id="sec_password_hide" name="password" value="输入密码" nullmsg="密码不能为空！" datatype="*3-16" errormsg="密码范围在3~16位之间！" sucmsg="密码验证通过！"/>
        </div>
        <div id="code">
          <label>验证码：</label>
...
<div class="bottom">©2014 Leting <a href="javascript:;" target="_blank">关于</a> <span>京ICP证030173号</span> </div>
<div class="screenbg">
  <ul>
   <%-- <li><a href="javascript:;"><img src="/image/timg.jpg"></a></li>
   &lt;%&ndash; --%>
