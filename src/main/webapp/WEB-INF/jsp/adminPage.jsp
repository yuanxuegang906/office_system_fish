...
<div style="width: 80%;margin-left: 10%;">
    <nav class="navbar navbar-default navbar-static-top">
        <div class="navbar-header">
            ...
            <a href="#" class="navbar-brand">滴答后台管理</a>
        </div>
            ...
            <ul class="nav panel-group" id="myPanel">
                ...
                <li class="panel">
                    ...
                    <ul id="sub1" class="nav collapse panel-collapse">
                        <li>
                        <a href="/managerList" >
                            <span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<b>班主任管理</b>
                        </a>
                      </li>
                        <li>
                            <a href="/teacherList" id="showUser">
                                <span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<b>讲师管理</b>
                            </a>
                        </li>

                        <li>
                            <a href="/studentList" id="invalid">
                                <span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;<b>学生管理</b>
                            </a>

                    </ul>
                </li>
                <li class="panel">
                    <a href="#sub2" data-toggle="collapse" data-parent="#myPanel"> 班级信息管理
                        <span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
                    </a>
                    <ul id="sub2" class="nav panel-collapse collapse">
                        <li>
                            <a href="/classesList" id="showGoodsType">
                                <span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看班级
                            </a>
                        </li>
                        <li>
                            <a href="/addClasses" id="addGoodsType">
                ...
                <li class="panel">
                    <a href="#sub3" data-toggle="collapse" data-parent="#myPanel"> 角色管理
                        <span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
                    </a>
                    <ul id="sub3" class="nav panel-collapse collapse">
                        <li>
                            <a href="#" id="showGoods" >
                                <span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看角色信息
                            </a>
                        </li>
                        <li>
                            <a href="#" id="addGoods">
                                <span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;更改角色权限
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="panel">
                    <a href="#sub4" data-toggle="collapse" data-parent="#myPanel"> 课程管理
                        <span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
                    </a>
                    <ul id="sub4" class="nav panel-collapse collapse">
                        ...
                        <li>
                            <a href="#" >
                                <span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;增加课程
                            </a>
                        </li>
                    </ul>
                </li>
